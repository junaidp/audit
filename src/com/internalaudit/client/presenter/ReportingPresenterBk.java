...

{
	...
	public ReportingPresenterBk(InternalAuditServiceAsync rpcService, HandlerManager eventBus, Employee employee, Display view) 
	{
	...
	private void fetchAuditHeadExceptions(){
		rpcService.fetchAuditHeadExceptions(loggedInEmployee.getEmployeeId(),0, new AsyncCallback<ArrayList<Exceptions>>(){
	...
	private void fetchUserExceptions() {
		rpcService.fetchEmployeeExceptions(loggedInEmployee.getEmployeeId(),0, new AsyncCallback<ArrayList<Exceptions>>(){
